...
public class RoomEventType extends NamedType {
    ...
    /**
     * A type for registration
     */
    public static final String REGISTRATION_TYPE_NAME = "Registration";
    /**
     * A type for event open
     */
    public static final String OPEN_TYPE_NAME = "Open";
    /**
     * A type for event close
     */
    public static final String CLOSE_TYPE_NAME = "Close";
    /**
     * A type for reports
     */
